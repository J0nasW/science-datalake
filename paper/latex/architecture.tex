...
\node[countlabel] at (2.0, 0.2)    {133M};
\node[countlabel] at (2.0,-0.7)  {292M};
\node[countlabel] at (2.0,-1.7)  {159M};
\node[countlabel] at (2.0,-2.7)  {141K};
\node[countlabel] at (2.0,-3.7)  {60K};
\node[countlabel] at (2.0,-4.7)  {548K};
\node[countlabel] at (2.0,-5.7)  {4M};
...
\node[ontonode] (cso)   at (15.5, -6.80) {CSO (26K)};
