...
topic and ontology term sets; mappings are counted at a similarity threshold
of $\geq 0.65$. Precision, recall, and F1 are computed against a stratified
300-pair gold-standard annotation set (see Section~\ref{sec:validation}).
\textsuperscript{$\dagger$}Metrics to be filled after annotation.}
\label{tab:baselines}
\small
...
\midrule
Jaro--Winkler ($\geq 0.90$) & 937    & 675   & \textsuperscript{$\dagger$}--- & \textsuperscript{$\dagger$}--- & \textsuperscript{$\dagger$}--- \\
TF-IDF cosine               & 4,861  & 2,620 & \textsuperscript{$\dagger$}--- & \textsuperscript{$\dagger$}--- & \textsuperscript{$\dagger$}--- \\
BM25                        & 14,929 & 4,513 & \textsuperscript{$\dagger$}--- & \textsuperscript{$\dagger$}--- & \textsuperscript{$\dagger$}--- \\
BGE-large (ours)            & 16,150 & 4,509 & \textsuperscript{$\dagger$}--- & \textsuperscript{$\dagger$}--- & \textsuperscript{$\dagger$}--- \\
\bottomrule
\end{tabular}
\end{table}
