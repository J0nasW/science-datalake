...
public GitHub repository (\url{https://github.com/J0nasW/science-datalake}).
...
\begin{enumerate}[nosep]
  ...
  \item \textbf{Create views} (\texttt{create\_unified\_db.py}): generates
    the DuckDB database with 153~SQL views across 22~schemas.
...
(\texttt{SCHEMA.md}) that documents all 153~views with their columns,
types, row counts, and cross-dataset join strategies, designed to be
consumed by both LLM-based coding agents and human developers.
