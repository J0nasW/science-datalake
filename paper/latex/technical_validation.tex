...
\emph{incorrect} (unrelated). We report precision at each tier and aggregate
precision, recall, and F1 at the $\geq 0.65$ threshold. The same
gold-standard set was used to evaluate three lexical baselines (TF-IDF, BM25,
Jaro--Winkler; see Table~\ref{tab:baselines}).
...
points mark key thresholds. The embedding-based method (BGE-large)
dominates across all operating points.}
\label{fig:precision_recall}
\end{figure}

Prior to the gold-standard evaluation, manual inspection of the 97~most
difficult cases near the 0.85 threshold boundary had found zero
